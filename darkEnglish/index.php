        ...
        <div class="row home-details-container align-items-center">
            ...
            <div class="col-12 col-lg-8 offset-lg-4 home-details text-left text-sm-center text-lg-left">
                <div>
                    ...
                    <h1 class="text-uppercase poppins-font">ZAIN AL-IRAQ.<span>REAL ESTATE INVESTMENT</span></h1>
                    <p class="open-sans-font">Zain Iraq is one of the leading companies in the field of real estate
                        investments and urban development using the latest modern urban technology.</p>
                    <a class="button" href="about.php">
                        <span class="button-text">READ MORE ABOUT US</span>
