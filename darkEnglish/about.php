...
<html lang="en">
  ...
  <body class="about">
    ...
    >
      ...
      <span class="title-bg">WHO WE ARE</span>
    </section>
    <!-- Page Title Ends -->
    <!-- Main Content Starts -->
    <section
            ...
            <div class="row">
              ...
              <div class="col-9">
                <ul class="about-list list-unstyled open-sans-font">
                  <p>
                    We are looking for excellence and creativity in our work by
                    offering a new and modern lifestyle with unique facades and
                    designs that keep and designs that keep pace with the
              ...
              <div class="col-9">
                <ul class="about-list list-unstyled open-sans-font">
                  <p>
                    With deliberate steps and our technical staff in the fields
                    of design and implementation, we seek to add modernity to
                    our work so that our work contributes to making a positive
                    impact on society
                  </p>
                </ul>
              </div>
