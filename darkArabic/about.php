...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>About Us - Zain Al Iraq</title>
  ...
  <body class="about">
      ...
      <nav role="navigation" class="d-block d-lg-none">
        <div id="menuToggle">
          ...
          <ul class="list-unstyled" id="menu">
            ...
            <li>
              <a href="projects.php"
                ><i class="fa fa-folder-open"></i><span>المشاريع</span></a
              >
            </li>
            <!-- <li>
              <a href="portfolio.php"
    ...
    >
      <h1>معلومات <span>عنا</span></h1>
      <span class="title-bg">من نحن</span>
    </section>
    <!-- Page Title Ends -->
    <!-- Main Content Starts -->
    <section
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-5 col-xl-6">
            <div class="row" style="text-align: right">
              <div class="col-12">
                <h3 style="text-align: center;" class="text-uppercase custom-title mb-0 ft-wt-600">
                  من نحن
                </h3>
              </div>
              ...
              <div class="col-9">
                <ul class="about-list list-unstyled open-sans-font">
                  <p>
                    زين العراق هي احدى الشركات الرائدة في مجال الاستثمارات
                    العقارية و التطوير العمراني باستخدام احدث وسائل التكنلوجيا
                    العمرانية الحديثة نبحث عن التميز و الأبداع في اعمالنا من
                    خلال طرح اسلوب حياة جديد و عصري بواجهات و تصاميم فريده تواكب
                    تطورات العصر الجديد
                  </p>
                </ul>
              </div>
              ...
              <div class="col-9">
                <ul class="about-list list-unstyled open-sans-font">
                  <p>
                    بخطى مدروسة و كوادرنا الفنية في مجالات التصميم و التنفيذ
                    نسعى لإضافة الحداثة الى اعمالنا لتساهم اعمالنا في احداث
                    تأثير ايجابي في المجتمع
                  </p>
                </ul>
              </div>
            </div>
              ...
              <ul>
                <li>
                  ...
                  <h5 class="poppins-font text-uppercase">
                    PROJECT 1
                    <span class="place open-sans-font">{name}</span>
                  </h5>
              ...
              <ul>
                <li>
                  ...
                  <p class="open-sans-font">
                    ...
                    sed do tempor incididunt ut labore
                  </p>
                </li>
                <li>
                  <div class="icon">
