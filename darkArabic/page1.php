...
<style>
  ...
  .button-container a span:nth-child(1) {
    ...
    animation: animation 1.2s infinite; /* Adjusted duration to 1.2s */
}
...
.button-container a span:nth-child(2) {
    ...
    animation: animation2 1.2s infinite; /* Adjusted duration to 1.2s */
    animation-delay: .25s;
}
...
.button-container a span:nth-child(3) {
    ...
    animation: animation3 1.2s infinite; /* Adjusted duration to 1.2s */
    animation-delay: .5s;
}
...
.button-container a span:nth-child(4) {
    ...
    animation: animation4 1.2s infinite; /* Adjusted duration to 1.2s */
    animation-delay: .75s;
}
...
<body>
  <div id="particles-js">
    <div class="button-container">
      <a href="http://www.zainal-iraq.com/main/">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
